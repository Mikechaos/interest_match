...
class InterestsControllerTest < ActionController::TestCase
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post :create, interest: { description: @interest.description, lat: @interest.lat, lon: @interest.lon, name: @interest.name, user_id: @interest.user_id }
    end
  ...
  test "should update interest" do
    patch :update, id: @interest, interest: { description: @interest.description, lat: @interest.lat, lon: @interest.lon, name: @interest.name, user_id: @interest.user_id }
    assert_redirected_to interest_path(assigns(:interest))
  end
